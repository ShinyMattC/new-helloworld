...
class Calc:
    ...
    def cos(self, x):
        xInRadians = x * math.pi/180
        return xInRadians - pow(xInRadians, 2)/math.factorial(2) + pow(xInRadians, 4)/math.factorial(4) - pow(xInRadians, 6)/math.factorial(6) + pow(xInRadians, 8)/math.factorial(8) - pow(xInRadians, 10)/math.factorial(10)
